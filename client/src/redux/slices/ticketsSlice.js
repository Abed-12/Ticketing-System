...
const initialState = {
    list: [
        ...
        { id: generateId(), title: 'API Timeout Issue', description: 'API requests are timing out', status: 'Resolved', assignee: 'null', urgency: 'Medium', dateTime: '2025-03-06 11:30 a.m.', creator: 'Mohamed Tarek', solve: 'Fixed the API timeout issue by optimizing the database queries and increasing server timeout' },
